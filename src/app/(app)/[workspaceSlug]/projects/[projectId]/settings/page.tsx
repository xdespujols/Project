...
import { db } from '@/db';
import { states, labels, projects, customProperties, automations } from '@/db/schema';
...
export default async function ProjectSettingsPage({ params }: Props) {
  ...
  const projectAutomations = await db
    .select()
    .from(automations)
  ...
  return (
    <div className="max-w-3xl mx-auto p-8">
      ...
      <section>
        ...
        <AutomationsManager automations={projectAutomations} projectId={projectId} />
      </section>
    </div>
  );
}
